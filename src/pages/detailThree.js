      ...
      <div className='whiteCover'>
        {selectedStations.length > 0 && ( // Check if at least three stations are available
          <div key={selectedStations[2].id}> {/* Accessing data from the third station */}
            <div className='selectedStation'>Paleisstraat</div>
            ...
            <div className='infoBoxes'>
              <div className='infoBox'>
                ...
                <div className='infoCode'>
                  {currentLocation && (
                    <div className=''>{calculateDistance(currentLocation.latitude, currentLocation.longitude, selectedStations[2].latitude, selectedStations[2].longitude).toFixed(2)} km</div>
                  )}
                </div>
              </div>
